...
export const optimistic = {
  ...
  simConfig: {
    ...
    dayOffset: { value: -1, step: 1, round: 0 },
    R0: { value: 2.7, min: 0, max: 5, step: 0.1, round: 1 },
  ...
  controls : {
    social: {
      ...
      values: [
        ...
        { x: { value: 121 }, y: { value: 0.1 } },
        { x: { value: 152 }, y: { value: 0.25 } },
      ],
    ...
    tests: {
      ...
      values: [
        ...
        { x: { value: 88 }, y: { value: 5.1 } },
        { x: { value: 132 }, y: { value: 5.5 } },
      ],
      x: { min: 0, max: 365, step: 5 },
